...
class WeightsPerClass {
  const WeightsPerClass({required this.baseExtrinsic, this.maxExtrinsic, this.maxTotal, this.reserved});
  ...
  @override
  int get hashCode => Object.hash(baseExtrinsic, maxExtrinsic, maxTotal, reserved);
}
...
class $WeightsPerClassCodec with _i1.Codec<WeightsPerClass> {
  ...
  @override
  void encodeTo(WeightsPerClass obj, _i1.Output output) {
    _i2.Weight.codec.encodeTo(obj.baseExtrinsic, output);
    const _i1.OptionCodec<_i2.Weight>(_i2.Weight.codec).encodeTo(obj.maxExtrinsic, output);
    const _i1.OptionCodec<_i2.Weight>(_i2.Weight.codec).encodeTo(obj.maxTotal, output);
    const _i1.OptionCodec<_i2.Weight>(_i2.Weight.codec).encodeTo(obj.reserved, output);
  }
