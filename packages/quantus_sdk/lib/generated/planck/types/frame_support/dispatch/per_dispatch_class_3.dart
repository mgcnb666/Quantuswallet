...
class PerDispatchClass {
  const PerDispatchClass({required this.normal, required this.operational, required this.mandatory});
  ...
  Map<String, int> toJson() => {'normal': normal, 'operational': operational, 'mandatory': mandatory};
  ...
  @override
  int get hashCode => Object.hash(normal, operational, mandatory);
}
...
class $PerDispatchClassCodec with _i1.Codec<PerDispatchClass> {
  ...
  @override
  void encodeTo(PerDispatchClass obj, _i1.Output output) {
    _i1.U32Codec.codec.encodeTo(obj.normal, output);
    _i1.U32Codec.codec.encodeTo(obj.operational, output);
    _i1.U32Codec.codec.encodeTo(obj.mandatory, output);
  }
