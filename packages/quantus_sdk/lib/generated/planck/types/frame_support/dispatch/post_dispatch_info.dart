...
class PostDispatchInfo {
  const PostDispatchInfo({this.actualWeight, required this.paysFee});
  ...
  Map<String, dynamic> toJson() => {'actualWeight': actualWeight?.toJson(), 'paysFee': paysFee.toJson()};
  ...
  @override
  int get hashCode => Object.hash(actualWeight, paysFee);
}
...
class $PostDispatchInfoCodec with _i1.Codec<PostDispatchInfo> {
  ...
  @override
  void encodeTo(PostDispatchInfo obj, _i1.Output output) {
    const _i1.OptionCodec<_i2.Weight>(_i2.Weight.codec).encodeTo(obj.actualWeight, output);
    _i3.Pays.codec.encodeTo(obj.paysFee, output);
  }
