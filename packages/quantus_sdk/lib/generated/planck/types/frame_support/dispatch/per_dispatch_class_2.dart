...
class $PerDispatchClassCodec with _i1.Codec<PerDispatchClass> {
  ...
  void encodeTo(PerDispatchClass obj, _i1.Output output) {
    _i2.WeightsPerClass.codec.encodeTo(obj.normal, output);
    _i2.WeightsPerClass.codec.encodeTo(obj.operational, output);
    _i2.WeightsPerClass.codec.encodeTo(obj.mandatory, output);
  }
