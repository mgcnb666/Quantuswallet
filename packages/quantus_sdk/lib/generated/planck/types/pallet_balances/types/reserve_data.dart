...
class ReserveData {
  const ReserveData({required this.id, required this.amount});
  ...
  Map<String, dynamic> toJson() => {'id': id.toList(), 'amount': amount};

  @override
  bool operator ==(Object other) =>
      identical(this, other) || other is ReserveData && _i3.listsEqual(other.id, id) && other.amount == amount;
...
class $ReserveDataCodec with _i1.Codec<ReserveData> {
  ...
  @override
  void encodeTo(ReserveData obj, _i1.Output output) {
  ...
  ReserveData decode(_i1.Input input) {
    return ReserveData(id: const _i1.U8ArrayCodec(8).decode(input), amount: _i1.U128Codec.codec.decode(input));
  }
