...
class RuntimeVersion {
  ...
  Map<String, dynamic> toJson() => {
    ...
    'apis': apis.map((value) => [value.value0.toList(), value.value1]).toList(),
  ...
  bool operator ==(Object other) =>
      ...
      other is RuntimeVersion &&
          ...
          _i5.listsEqual(other.apis, apis) &&
...
class $RuntimeVersionCodec with _i1.Codec<RuntimeVersion> {
  ...
  @override
  void encodeTo(RuntimeVersion obj, _i1.Output output) {
    _i1.StrCodec.codec.encodeTo(obj.specName, output);
    _i1.StrCodec.codec.encodeTo(obj.implName, output);
    _i1.U32Codec.codec.encodeTo(obj.authoringVersion, output);
    _i1.U32Codec.codec.encodeTo(obj.specVersion, output);
    _i1.U32Codec.codec.encodeTo(obj.implVersion, output);
    const _i1.SequenceCodec<_i6.Tuple2<List<int>, int>>(
      _i6.Tuple2Codec<List<int>, int>(_i1.U8ArrayCodec(8), _i1.U32Codec.codec),
    ).encodeTo(obj.apis, output);
    _i1.U32Codec.codec.encodeTo(obj.transactionVersion, output);
    _i1.U8Codec.codec.encodeTo(obj.systemVersion, output);
  }
